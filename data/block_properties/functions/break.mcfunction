...
execute unless entity @p[nbt={SelectedItem:{id:"minecraft:shears",Count:1b}}] run scoreboard players set min RNG_77 9
execute unless entity @p[nbt={SelectedItem:{id:"minecraft:shears",Count:1b}}] run scoreboard players set max RNG_77 9
